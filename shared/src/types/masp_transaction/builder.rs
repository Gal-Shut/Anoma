...
use super::AssetType;
use masp_primitives::amount::zec;
pub use secp256k1;
pub use ripemd160;
...
use masp_primitives::amount::{Amount, default_fee};
use super::{
        components::{OutputDescription, SpendDescription, ConvertDescription, TxOut},
        signature_hash_data, Transaction, TransactionData, SIGHASH_ALL,
    };

use masp_primitives::legacy::Script;
use super::components::{OutPoint, TxIn};
...
mod tests {
    ...
    use rand_core::OsRng;
    use std::marker::PhantomData;
    use masp_primitives::amount::{Amount, zec};

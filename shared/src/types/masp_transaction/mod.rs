...
use masp_primitives::redjubjub::Signature;
use masp_primitives::serialize::Vector;
use masp_primitives::util::*;
...
use self::components::{JSDescription, ConvertDescription, OutputDescription, SpendDescription, TxIn, TxOut};
